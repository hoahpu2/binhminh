  ...
  <div class="row">
    ...
    <div class="col-md-12">
      ...
      <div class="box box-info">
        ...
        <!-- /.box-header -->
        <!-- form start -->
        <form action="{{ route('admin.news.postEdit') }}" class="form-horizontal" method="POST" enctype="multipart/form-data" autocomplete="off">
          @csrf
          <input type="hidden" value="{{$news->N_id}}" name="N_id">
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-6">
                <input type="text" class="form-control"  value ="{{$news->N_title}}"  name="N_title" id="inputEmail3" placeholder="Tiêu đề tin tức" value="{{old('N_title')}}">
...
{{$news->N_content}}{{old('N_content')}}
        ...
        <div class="form-group">
          ...
          <div class="col-sm-5">
            <img  class="thumbnail" src="{{url('resources/upload/news/')}}/{{$news->N_avatar}}" width="200px" height="200px">
          </div>
        </div>
        <div class="form-group">
