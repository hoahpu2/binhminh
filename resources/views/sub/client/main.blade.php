        ...
        <div class="content">
            ...
            <div class="section group">
                @foreach($saleProduct as $sale)
                    <div class="grid_1_of_4 images_1_of_4">
                        <a href=""><img src="{{asset('resources/upload/product/'.$sale->PR_avatar)}}" alt="" /></a>
                        <h2>{{$sale->PR_name}} </h2>
                        <p>{{$sale->PR_sortDesc}}</p>
                        <p><span class="strike">{{$new->PR_sale}}</span><span class="price">{{$sale->PR_price}}</span></p>
                        <div class="button"><span><img src="{{asset('images/cart.jpg')}}" alt="" /><a href="preview-3.html" class="cart-button">Liên hệ</a></span> </div>
                        <div class="button"><span><a href="preview-3.html" class="details">Chi tiết</a></span></div>
                    </div>
                @endforeach()
