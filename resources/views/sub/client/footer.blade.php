    ...
    <div class="footer-widgets footer footer-2 dark">
        <div class="row dark large-columns-1 mb-0">
            <div id="block-3" class="col pb-0 widget widget_block">
                <div class="row" id="row-864408980">
                    ...
                    <div id="col-1708175132" class="col medium-3 small-6 large-3">
                        <div class="col-inner">



                            <div class="container section-title-container">
                                <h4 class="section-title section-title-normal"><b></b><span class="section-title-main" style="font-size:80%;">Trụ Sở Chính</span><b></b></h4>
                            </div>
                    ...
                    <div id="col-1902242972" class="col medium-3 small-6 large-3">
                        <div class="col-inner">



                            <div class="container section-title-container">
                                <h4 class="section-title section-title-normal"><b></b><span class="section-title-main" style="font-size:80%;">Liên kết nhanh</span><b></b></h4>
                            </div>

                            <div class="nav-wrapper">
                                <ul class="nav nav-uppercase nav-vertical nav-size-small nav-simple text-left nav-left">
                                    <li class=><a href="lien-ket-nhanh/ve-chung-toi/index.html">Về Chúng Tôi</a></li>
                                    <li class=><a href="lien-ket-nhanh/1961-2/index.html">Liên Hệ</a></li>
                                    <li class=><a href="lien-ket-nhanh/tuyen-dung/index.html">Tuyển Dụng</a></li>
                                    <li class=><a href="lien-ket-nhanh/giai-phap/index.html">Giải Pháp</a></li>
                                </ul>
                            </div>
                    ...
                    <div id="col-975869971" class="col medium-3 small-6 large-3">
                        <div class="col-inner">



                            <div class="container section-title-container">
                                <h4 class="section-title section-title-normal"><b></b><span class="section-title-main" style="font-size:80%;">Nhận thông tin</span><b></b></h4>
                            </div>
                            ...
                            <div role="form" class="wpcf7" id="wpcf7-f7114-o1" lang="vi" dir="ltr">
                                <div class="screen-reader-response">
                                    <p role="status" aria-live="polite" aria-atomic="true"></p>
                                    <ul></ul>
                                </div>
                                <form action="http://ipe.vn/#wpcf7-f7114-o1" method="post" class="wpcf7-form init" novalidate="novalidate" data-status="init">
                                    <div style="display: none;">
                                        <input type="hidden" name="_wpcf7" value="7114" />
                                        <input type="hidden" name="_wpcf7_version" value="5.5.2" />
                                        <input type="hidden" name="_wpcf7_locale" value="vi" />
                                        <input type="hidden" name="_wpcf7_unit_tag" value="wpcf7-f7114-o1" />
