            ...
            <div class="flex-row container">
                ...
                <div class="flex-col hide-for-medium flex-right">
                    <ul class="nav top-bar-nav nav-right nav-small  nav-divided">
                        <li id="menu-item-7343" class="menu-item menu-item-type-taxonomy menu-item-object-category menu-item-7343 menu-item-design-default"><a href="category/tin-tuc/index.html" class="nav-top-link">Tin Tức</a></li>
                        <li id="menu-item-7133" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-7133 menu-item-design-default"><a href="hoi-dap/index.html" class="nav-top-link">Hỏi Đáp</a></li>
                        <li id="menu-item-7132" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-7132 menu-item-design-default"><a href="dao-tao/index.html" class="nav-top-link">Đào Tạo</a></li>
                        <li id="menu-item-7134" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-7134 menu-item-design-default"><a href="lien-ket-nhanh/tuyen-dung/index.html" class="nav-top-link">Tuyển Dụng</a></li>
    ...
    flex-grow">
                ...
                <div class="flex-col hide-for-medium flex-right">
                    <ul class="header-nav header-nav-main nav nav-right  nav-size-large nav-spacing-xlarge nav-uppercase">
                        ...
                        <li id="menu-item-1916" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1916 menu-item-design-default"><a href="<?php echo route('sanpham'); ?>" class="nav-top-link">Sản Phẩm</a></li>
